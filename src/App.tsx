      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route 
            ...
            element={
              <ProtectedRoute allowedRoles={["Admin", "SuperAdmin"]}>
                <PlaceholderPage title="Society Setup" phaseNeeded={3} />
              </ProtectedRoute>
            } 
          />
          <Route 
            ...
            element={
              <ProtectedRoute allowedRoles={["Admin", "SuperAdmin"]}>
                <PlaceholderPage title="Buildings Setup" phaseNeeded={3} />
              </ProtectedRoute>
            } 
          />
          <Route 
            ...
            element={
              <ProtectedRoute allowedRoles={["Admin", "SuperAdmin"]}>
                <PlaceholderPage title="Flats Configuration" phaseNeeded={3} />
              </ProtectedRoute>
            } 
          />
          <Route 
